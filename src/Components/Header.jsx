    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-4 py-5 justify-content-end d-flex my-3 mb-4">
          <a
            href="https://app.withotter.com/log-in?device-id=zV2leBbFxJ7xn0FYHcVKtO"
            className="fw-bold mx-2 text-decoration-none btn "
          ...
          <Button
            link={
              "https://app.withotter.com/log-in?device-id=zV2leBbFxJ7xn0FYHcVKtO"
            }
            buttonText={"Sign up"}
          />
        </div>
