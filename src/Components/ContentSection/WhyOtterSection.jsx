...
const WhyOtterSection = () => {
  return (
    <div className="my-5 py-5 second-slide-main">
      {/* first section row */}
      <div className="row">
        <div className="col-3 col-sm-3 d-none d-sm-block"></div>
      ...
      <div className="row d-flex justify-content-evenly align-item-center my-3 py-5">
        <div className="col-5  border-radius shadow">
